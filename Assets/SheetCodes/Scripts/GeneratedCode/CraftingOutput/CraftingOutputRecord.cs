...
namespace SheetCodes
{
	...
	[Serializable]
	public class CraftingOutputRecord : BaseRecord<CraftingOutputIdentifier>
	{
		...
		[ColumnName("Chance")] [SerializeField] private float _chance = default;
		public float Chance { get { return _chance; } set { if(!CheckEdit()) return; _chance = value; }}
        ...
        public CraftingOutputModel model { get { return ModelManager.CraftingOutputModel; } }
        private CraftingOutputRecord originalRecord = default;
        ...
        public override void CreateEditableCopy()
        {
            ...
            CraftingOutputRecord editableCopy = new CraftingOutputRecord();
        ...
        private void CopyData(CraftingOutputRecord record)
        {
            record._minAmount = _minAmount;
            record._maxAmount = _maxAmount;
            record._chance = _chance;
            record._item = _item;
        }
