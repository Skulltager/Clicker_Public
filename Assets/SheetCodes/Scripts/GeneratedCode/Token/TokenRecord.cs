...
namespace SheetCodes
{
	...
	[Serializable]
	public class TokenRecord : BaseRecord<TokenIdentifier>
	{
        ...
        public TokenModel model { get { return ModelManager.TokenModel; } }
        private TokenRecord originalRecord = default;
        ...
        public override void CreateEditableCopy()
        {
            ...
            TokenRecord editableCopy = new TokenRecord();
        ...
        private void CopyData(TokenRecord record)
        {
            record._icon = _icon;
        }
